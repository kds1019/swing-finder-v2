...
page = st.sidebar.radio(
    "Go to:",
    ["Scanner", "News", "Strength", "Analyzer", "Active Trades", "Alerts"],
    index=["Scanner", "News", "Strength", "Analyzer", "Active Trades", "Alerts"].index(st.session_state["active_page"]) if st.session_state["active_page"] in ["Scanner", "News", "Strength", "Analyzer", "Active Trades", "Alerts"] else 0,
)
