...
page = st.sidebar.radio(
    "Go to:",
    ["Scanner", "News", "Strength", "Analyzer", "Active Trades", "Alerts", "Backtest"],
    index=["Scanner", "News", "Strength", "Analyzer", "Active Trades", "Alerts", "Backtest"].index(st.session_state["active_page"]) if st.session_state["active_page"] in ["Scanner", "News", "Strength", "Analyzer", "Active Trades", "Alerts", "Backtest"] else 0,
)
